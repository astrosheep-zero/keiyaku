---
id: task/删除-bind-coordinate-错误的无读者-code
...
relates: []
note: ""
createdAt: 2026-08-07T04:49:03.580Z
...
错误 subclass/code 已删除；旧任务残留的观察 Git 后抛 TypeError 要求违反 public-api 的 package-edge 输入错误边界，不继续实现。
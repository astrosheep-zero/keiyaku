...
relates: []
note: ""
createdAt: 2026-08-07T05:00:25.266Z
...
任务证据已过时：pid/status 仍参与 unknown/non-published 分类，旧 errorBytes 重复已不存在。仅剩无读者 stderr 存储可在下次修改 repository 时直接删除，不为它新增统一诊断机制或独立任务。
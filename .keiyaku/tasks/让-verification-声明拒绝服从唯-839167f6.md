---
id: task/让-verification-声明拒绝服从唯-839167f6
title: 让 Verification 声明拒绝服从唯一法定 decide
state: drop
priority: 0
needs:
  - task/统一-staged-decide-与-document-curre-1dc4f58b
parent: null
supersedes: []
relates: []
note: ""
...
完整失败样例与优先级验收已并入 迁移-library-方言与-verification-aca216f8；保留两项会让同一 declaration legality 有两个进度 owner。
...
A body-less publication composed before a schema Tell exits cleanly before that
Tell is admitted; it never makes the Tell contend with its own birth Body.

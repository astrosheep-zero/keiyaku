...
export const akumaZones = [
  ...
  },
  {
    ...
    allow: [
      ...
      any("akuma/identity.ts", ["worldRootForAkumaPaths", "AkuId"]),
  ...
  },
  {
    ...
    allow: [
      ...
      any("akuma/identity.ts", ["pathsForAkuId", "AkumaPaths", "AkuId"]),
      any("akuma/publication.ts", ["BIRTH_TIMEOUT_MS"]),
      any("akuma/request-wire.ts", ["atomicJson", "decodeClaim", "receiptPath", "StructuralRequestClaim"]),

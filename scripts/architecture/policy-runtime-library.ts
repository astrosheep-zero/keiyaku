...
export const runtimeLibraryZones = [
  ...
  },
  {
    ...
    allow: [
      ...
      any("library/input.ts", ["actorOption", "documentDerivation", "optionalNonblank"]),
      types("library/configuration.ts", ["WorktreeHooks"]),
      any("library/repo.ts", ["Repo", "scopeForRepo"]),
      any("core/facts/types.ts", ["contractId", "ContractId", "ContractState"]),
      any("git/read-observation.ts", ["withGitDecodeChannel", "GitDecodeChannel"]),
      types("akuma/requests.ts", ["UpstreamRequestOutcome"]),

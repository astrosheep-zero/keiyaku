...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  zones: [
    ...
    { source: "identity/selector.ts", allow: [] },
    ...
    },
    {
      ...
      allow: [
        ...
        any("git/observe.ts", ["observeContract", "observeGitForAdmission"]),
  ...
  capabilityRules: [
    ...
    { capability: "new-date-current", owners: ["akuma/akuma.ts", "akuma/body.ts", "akuma/publication.ts", "dispatch/index.ts", "protocol/bind.ts", "protocol/operations.ts", "task/compose.ts", "task/operations.ts"] },

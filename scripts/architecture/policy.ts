  ...
  zones: [
    ...
    },
    {
      ...
      allow: [
        ...
        any("kanshi/**"), any("library/region.ts", ["readRegionDeclarations", "validateRegionPatterns"]),
        any("core/facts/types.ts", ["contractId"]),
    ...
    { source: "kanshi/report.ts", allow: [types("world.ts"), types("akuma/index.ts"), types("identity/selector.ts"), types("library/contract.ts"), types("library/region.ts", ["RegionOverlap"]), types("protocol/read/observation.ts", ["CurrentPhysicalIssue"]), types("task/index.ts")] },

  ...
  sensitiveImports: [
    ...
    { module: "fs", owners: [] },
    {
      ...
      owners: [
        ...
        ...ownersFor(["lstat", "realpath", "access"], "cli/coordinates.ts", "git/scratch.ts"),
        ...
        ...ownersFor(["lstat"], "akuma/heart/storage.ts"),
        ...
        { source: "runtime/proc/process-exit.ts", symbols: ["FileHandle", "open"] },
        { source: "runtime/proc/run.ts", symbols: ["open"] },
        { source: "runtime/proc/windows-run.ts", symbols: ["FileHandle", "open"] },

...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  ...
  capabilityRules: [
    ...
    { capability: "process-environment", owners: ["akuma/providers/claude/index.ts", "akuma/providers/codex-app-server/index.ts", "akuma/requests.ts", "cli/invoke.ts", "cli/main.ts", "git/repository.ts", "protocol/operations.ts", "runtime/proc/**"] },

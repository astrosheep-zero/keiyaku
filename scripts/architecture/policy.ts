...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  zones: [
    ...
    { source: "task/identity.ts", allow: [any("identity/coordinates.ts"), any("identity/normalize.ts")] }, { source: "task/context.ts", allow: [any("identity/normalize.ts")] },
    ...
    { source: "settlement/settle.ts", allow: [types("carrier/reconcile.ts"), any("core/facts/types.ts"), any("task/context.ts"), any("task/operations.ts"), types("task/identity.ts"), types("task/store.ts")] },

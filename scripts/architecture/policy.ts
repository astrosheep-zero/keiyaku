...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  zones: [
    ...
    { source: "settlement/settle.ts", allow: [types("git/reconcile.ts"), any("core/facts/types.ts"), any("task/context.ts"), any("task/operations.ts"), types("task/identity.ts"), types("task/store.ts")] },
  ...
  sensitiveImports: [
    ...
    { module: "fs/promises", owners: [] },
    {
      module: "node:crypto",
      owners: [
        { source: "git/verification.ts", symbols: ["randomBytes"] },

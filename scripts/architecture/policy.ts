...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  ...
  capabilityRules: [
    ...
    { capability: "process-environment", owners: ["cli/invoke.ts", "cli/main.ts", "carrier/repository.ts", "protocol/operations.ts"] },
    ...
    { capability: "type-error-construction", owners: ["body/**", "cli/actor.ts", "kanshi/**", "library/keiyaku.ts", "identity/coordinates.ts", "namespace-context.ts", "task/**"] },
  ],
  forbiddenFileNames: [

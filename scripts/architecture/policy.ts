...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  zones: [
    ...
    { source: "akuma/providers/acp/index.ts", allow: [types("akuma/provider.ts"), types("akuma/provider-recipe.ts"), any("akuma/providers/acp/core.ts")] },
    ...
    },
    {
      ...
      allow: [
        ...
        any("akuma/request-serve.ts", ["BodyRequestPump", "clearBodyRequestTransport", "settleBodyRequests", "UpstreamExecutionPort", "RequestChildLaunch"]),
    ...
    { source: "task/mutation.ts", allow: [types("world.ts"), types("task/compose.ts"), any("task/input.ts"), any("task/index.ts", ["Tasks"]), types("task/identity.ts"), types("task/operations.ts")] },
  ...
  sensitiveImports: [
    ...
    { module: "child_process", owners: [] },
    {
      ...
      owners: [
        ...
        { source: "task/store.ts", symbols: ["closeSync", "fsyncSync", "openSync", "renameSync", "writeFileSync"] },
        { source: "coordination/durable-file.ts", symbols: ["closeSync", "fsyncSync", "openSync", "renameSync", "writeFileSync"] },
    ...
    { module: "fs", owners: [] },
    {
      ...
      owners: [
        ...
        { source: "akuma/heart/storage.ts", symbols: ["lstat"] },
        ...
        { source: "git/hooks.ts", symbols: ["mkdir", "readFile"] },
        { source: "git/reconcile.ts", symbols: ["access", "mkdir"] },
        { source: "git/scratch.ts", symbols: ["realpath"] },
        { source: "git/target-placement.ts", symbols: ["lstat"] },
    ...
    { module: "fs/promises", owners: [] },
    {
      module: "node:crypto",
      owners: [
        { source: "coordination/durable-file.ts", symbols: ["randomBytes"] }, { source: "git/scratch.ts", symbols: ["randomBytes"] },
        { source: "cli/draft.ts", symbols: ["createHash"] },
        ...
        { source: "akuma/request-wire.ts", symbols: ["randomUUID"] },
    ...
    { module: "node:sqlite", owners: [
      ...
      { source: "akuma/heart/soul.ts", symbols: ["DatabaseSync"], mode: "type-only" },
      ...
      { source: "akuma/heart/request-rows.ts", symbols: ["DatabaseSync"], mode: "type-only" },
      { source: "akuma/heart/timeline.ts", symbols: ["DatabaseSync"], mode: "type-only" },

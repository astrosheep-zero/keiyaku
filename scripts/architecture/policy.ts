  ...
  zones: [
    ...
    },
    {
      ...
      allow: [
        ...
        any("akuma/provider-recipe.ts", ["decodeProviderOptions", "decodeReadonlyRestraint"]),
  ...
  sensitiveImports: [
    ...
    { module: "fs", owners: [] },
    {
      ...
      owners: [
        ...
        { source: "akuma/requests.ts", symbols: ["access", "mkdir", "readFile", "readdir", "rename", "rm", "writeFile"] },

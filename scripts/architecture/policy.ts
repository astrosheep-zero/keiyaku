...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  zones: [
    ...
    { source: "akuma/heart/index.ts", allow: [types("akuma/identity.ts"), any("akuma/heart/facts.ts"), any("akuma/heart/rows.ts"), any("akuma/heart/tells.ts"), any("akuma/heart/timeline.ts"), any("akuma/heart/storage.ts")] },
    ...
    { source: "akuma/providers/index.ts", allow: [types("akuma/heart/index.ts"), types("akuma/provider.ts"), any("akuma/providers/claude/index.ts"), any("akuma/providers/codex-app-server/index.ts"), any("akuma/providers/opencode-sdk/index.ts")] },

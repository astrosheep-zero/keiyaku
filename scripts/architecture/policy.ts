...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  zones: [
    ...
    { source: "akuma/providers/claude/index.ts", allow: [any("akuma/abort.ts"), any("akuma/provider.ts"), types("akuma/provider-recipe.ts"), any("akuma/providers/claude/events.ts"), any("akuma/providers/claude/input.ts")] },
    ...
    { source: "akuma/providers/codex-app-server/index.ts", allow: [any("akuma/providers/codex-app-server/events.ts"), any("akuma/provider.ts"), types("akuma/provider-recipe.ts"), any("runtime/proc/line-rpc.ts")] },
    { source: "akuma/providers/acp/core.ts", allow: [any("akuma/abort.ts"), any("akuma/providers/acp/events.ts"), any("akuma/provider.ts"), any("runtime/proc/stdio.ts")] },
    ...
    { source: "akuma/providers/opencode-sdk/session.ts", allow: [any("akuma/abort.ts"), types("akuma/heart/index.ts"), types("akuma/provider-recipe.ts"), any("runtime/proc/run.ts")] },
    ...
    },
    {
      ...
      allow: [
        ...
        types("git/repository.ts"),
        any("git/workspace.ts", ["deliveryWorktreePath", "observeTargetLag", "observeWorkspace"]),
    ...
    },
    {
      ...
      allow: [
        ...
        any("protocol/operations.ts", ["auditOperation", "AuditReport", "RepositoryScope"]),

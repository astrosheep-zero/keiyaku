...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  zones: [
    ...
    { source: "akuma/heart/facts.ts", allow: [types("akuma/identity.ts"), types("akuma/coordinate.ts")] },
    { source: "akuma/heart/schema.ts", allow: [] },
    { source: "akuma/coordinate.ts", allow: [] },
    { source: "akuma/heart/rows.ts", allow: [types("akuma/heart/facts.ts"), types("akuma/identity.ts"), any("akuma/coordinate.ts")] },
    ...
    { source: "akuma/heart/storage.ts", allow: [types("akuma/identity.ts"), types("akuma/heart/facts.ts"), any("akuma/heart/schema.ts"), any("akuma/heart/rows.ts"), any("akuma/heart/tells.ts", ["insertTellFact"]), any("akuma/heart/timeline.ts", ["pruneActivityFacts"])] },
    { source: "akuma/heart/index.ts", allow: [types("akuma/identity.ts"), types("akuma/coordinate.ts"), any("akuma/heart/facts.ts"), any("akuma/heart/rows.ts"), any("akuma/heart/tells.ts"), any("akuma/heart/timeline.ts"), any("akuma/heart/storage.ts")] },
    ...
    { source: "akuma/providers/index.ts", allow: [types("akuma/heart/index.ts"), types("akuma/provider.ts"), any("akuma/providers/claude/index.ts"), any("akuma/providers/codex-app-server/index.ts"), any("akuma/providers/opencode-sdk/index.ts"), any("akuma/providers/pi/index.ts")] },
  ...
  capabilityRules: [
    ...
    { capability: "process-environment", owners: ["akuma/providers/claude/index.ts", "akuma/providers/codex-app-server/index.ts", "akuma/providers/opencode-sdk/session.ts", "akuma/requests.ts", "cli/invoke.ts", "cli/main.ts", "git/repository.ts", "protocol/operations.ts", "runtime/proc/**"] },

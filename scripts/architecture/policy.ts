...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  zones: [
    ...
    { source: "coordination/**", allow: [any("identity/coordinates.ts"), any("identity/normalize.ts")] },
    ...
    { source: "task/store.ts", allow: [any("coordination/namespace-context.ts"), any("coordination/sqlite-transaction-lock.ts"), any("task/board.ts"), any("task/document.ts"), any("task/identity.ts")] },
    { source: "task/operations.ts", allow: [any("markdown/diff.ts"), any("task/board.ts"), any("task/document.ts"), any("task/identity.ts"), any("task/store.ts")] },
    { source: "task/compose.ts", allow: [any("markdown/diff.ts"), any("task/board.ts"), any("task/document.ts"), any("task/identity.ts"), any("task/operations.ts"), any("task/store.ts")] },
  ...
  sensitiveImports: [
    ...
    { module: "child_process", owners: [] },
    {
      ...
      owners: [
        ...
        { source: "coordination/namespace-context.ts", symbols: ["closeSync", "fsyncSync", "lstatSync", "mkdirSync", "openSync", "readFileSync", "renameSync", "unlinkSync", "writeFileSync"] },
    ...
    { module: "fs/promises", owners: [] },
    {
      ...
      owners: [
        ...
        { source: "coordination/namespace-context.ts", symbols: ["randomBytes"] },
        { source: "task/store.ts", symbols: ["randomBytes"] },
        { source: "coordination/sqlite-transaction-lock.ts", symbols: ["randomInt"] },
      ],
    },
    { module: "node:sqlite", owners: [{ source: "coordination/sqlite-transaction-lock.ts", symbols: ["DatabaseSync"] }] },
  ...
  capabilityRules: [
    ...
    { capability: "type-error-construction", owners: ["body/**", "cli/actor.ts", "library/keiyaku.ts", "identity/coordinates.ts", "coordination/namespace-context.ts", "task/**"] },
  ],
  forbiddenFileNames: [

  ...
  zones: [
    ...
    },
    {
      ...
      allow: [
        ...
        any("protocol/run.ts"),
        any("settlement/holder.ts", ["readTaskHolderProjectionFromDecision", "taskHolderObservationSelection"]),
    ...
    },
    {
      ...
      allow: [
        ...
        types("protocol/run.ts"),
        any("settlement/holder.ts", ["readTaskHolderProjectionFromDecision", "taskHolderObservationSelection"]),
        types("settlement/holder.ts", ["TaskHolderBindRefusal"]),
        any("task/document.ts", ["completeTaskDocument", "parseTaskDocument"]),
        any("task/identity.ts", ["parseTaskId", "taskAuthorityRelativePath", "TaskId"]),
        types("verification/declaration.ts"),
      ],
    },
    {

...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  zones: [
    ...
    { source: "akuma/providers/index.ts", allow: [types("akuma/provider.ts"), any("akuma/provider-recipe.ts"), any("akuma/providers/acp/index.ts"), any("akuma/providers/claude/index.ts"), any("akuma/providers/codex-app-server/index.ts"), any("akuma/providers/opencode-sdk/index.ts"), any("akuma/providers/pi/index.ts")] },
    ...
    { source: "akuma/providers/acp/index.ts", allow: [any("akuma/abort.ts"), any("akuma/providers/acp/events.ts"), any("akuma/provider.ts"), types("akuma/provider-recipe.ts"), any("runtime/proc/stdio.ts")] },

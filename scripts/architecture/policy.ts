...
export const KEIYAKU_ARCHITECTURE_POLICY = {
  ...
  capabilityRules: [
    ...
    { capability: "process-environment", owners: ["akuma/body.ts", "akuma/providers/acp/core.ts", "akuma/providers/claude/index.ts", "akuma/providers/codex-app-server/index.ts", "akuma/providers/opencode-sdk/session.ts", "akuma/requests.ts", "cli/invoke.ts", "cli/main.ts", "git/process.ts", "protocol/audit.ts", "protocol/deliver.ts", "runtime/proc/**"] },

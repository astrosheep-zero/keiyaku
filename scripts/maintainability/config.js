...
export const FILE_LINE_EXEMPTIONS = Object.freeze([
  ...
  owner("src/cli/render/kanshi.ts", "Kanshi rendering owns one report text projection whose sections share the same selection and availability semantics.", 501),
  ...
  owner("src/git/target-placement.ts", "Target placement owns appointment and physical placement decisions across the existing delivery lifecycle.", 501),

...
export const FILE_LINE_EXEMPTIONS = Object.freeze([
  ...
  owner("src/cli/invoke.ts", "CLI invocation and adaptation stay one command boundary.", 699, [functionOwner("invokeParsed", "Parsing has already established the one invocation boundary; command adaptation and execution stay together.", 85)]),

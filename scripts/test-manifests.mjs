export const LOCAL_TEST_FILES = [
  ...
  "tests/cli-overlap-render.test.ts",
  ...
  "tests/contract-execution-observation.test.ts",
...
export const INTEGRATION_TEST_FILES = [
  ...
  "tests/akuma-heart-admission.test.ts",
  ...
  "tests/verification-scratch.test.ts",

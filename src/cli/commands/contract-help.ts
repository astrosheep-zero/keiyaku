...
export const CONTRACT_COMMAND_SPECS = {
  bind: {
    ...
    details: [
      ...
      "  ## Design       existing owner modules/entry points, reuse or change, implementation approach, and critical ordering",
      "                  unresolved architectural choices are settled before binding; private helper names",
      "                  and equivalent control flow remain Deliverer freedom",

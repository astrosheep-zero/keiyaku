...
export const CONTRACT_COMMAND_SPECS = {
  ...
  audit: { positional: "optional", stdin: "none", flags: { "include-dirty": "boolean", "show-diff-body": "boolean", actor: "value", json: "boolean" }, usage: "audit [<contract>|@<contract>] [--include-dirty] [--show-diff-body] [--actor <actor>] [--json]", purpose: "Preview one Contract candidate without placement." },

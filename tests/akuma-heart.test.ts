...
test("heart schema version 16 and leash schema version 4 hard-refuse old authority", async () => {
  ...
  try {
    ...
    leash.close();
    await assert.rejects(readHeart(allocated.paths), /heart schema version must be 16/u);

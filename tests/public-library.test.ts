...
test("package root exposes only the ruled library values and declarations", () => {
  ...
  const source = [
    ...
    'const statusRow: ContractRow = { id, title: "Boundary", phase: contractPhase, disposition: contractDisposition, workspace: "here", worktreePath: null, workspaceObservation: { kind: "clean", location: { kind: "here" }, counts: { staged: 0, unstaged: 0, untracked: 0, submodules: 0 } }, target: null, targetLag: { kind: "none" }, delivery: null, targetObservation: null, gates: { reports: [contractGateReport], satisfied: false } };',
